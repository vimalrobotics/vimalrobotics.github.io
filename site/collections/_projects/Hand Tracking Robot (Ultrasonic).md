...
## Overview
A simple mobile robot capable of tracking hand motion using ultrasonic distance sensing.
The system supported both manual remote control and autonomous tracking modes.
